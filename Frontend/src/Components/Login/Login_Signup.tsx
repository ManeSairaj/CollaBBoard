...
const Login_signup = () => {
  return (
    <div className="w-full h-screen my-auto space-y-6 text-gray-600 sm:max-w-md">
      <div className="text-center">
        <img
          src="src\assets\watermark_preview_image20240615-7-12xdps4-removebg-preview.png"
          width={130}
      ...
      <div className="bg-slate-100/25 backdrop-blur-lg shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
        <div className="grid grid-cols-3 gap-x-3">
          <button className="flex items-center justify-center py-2.5 bg-white border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100 shadow-2xl shadow-black">
            <svg
              className="w-5 h-5"
              viewBox="0 0 48 48"
              fill="none"
        ...
        <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
          <div>
            ...
            <input
              type="email"
              required
              className="w-full mt-2 px-3 py-2 bg-white text-gray-500 outline-none border focus:border-indigo-600 rounded-lg shadow-lg"
            />
          </div>
          <div>
